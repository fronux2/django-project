...
#@login_required
@permission_required('appweb.add_producto')
...
@permission_required('appweb.view_producto')
...
@permission_required('appweb.change_producto')
...
@permission_required('appweb.delete_producto')
